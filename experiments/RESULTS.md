...
| 2026-09-15 | **EXP12 rung3 8×8 tiles — LM head M=512 (flushed)** | M=512 | 10385 | 10385 | 10398 (warm) | µs | 94 GB/s | 5.2% BW | 0 err + racecheck 0 | **1.27× vs rung2**; **30.68 TFLOPS = 27.5% of FFMA peak — new ladder best**; REG:128 LOCAL:0 |
| 2026-09-15 | EXP12 rung3 — LM head M=256 (flushed) | M=256 | 5199 | 5199 | 5202 (warm) | µs | 182 GB/s | 10.1% BW | (same binary) | 1.28×; 30.65 TFLOPS — the only corner where the bigger tile pays |
| 2026-09-15 | EXP12 rung3 — MLP gate+up M=512 (flushed) | M=512 | 1361 | 1361 | 1213 (warm) | µs | 127 GB/s | 7.0% BW | (same binary) | **0.76× (slower); 18.94 TFLOPS → falsifier 2 FIRED (< 30 TFLOPS)** |
| 2026-09-15 | EXP12 rung3 — QKV / O-proj / MLP down M=512 | M=512 | — | — | — | µs | — | — | (same binary) | 0.62× / 0.36× / 0.36×; 12.39 / 6.22 / 6.51 TFLOPS — **grid parallelism**: BN=128 leaves QKV with 32 blocks of 512 threads vs 170 SMs (138 idle) at M≤256 |
| 2026-09-15 | EXP12 rung3 — all shapes M=1–64 | M≤64 | — | — | — | µs | — | — | (same binary) | 0.32–0.64× — deeper small-M regression than rung2 (BM=256 stages a 4× bigger predicated A-tile) |
| 2026-09-15 | EXP12 res-usage evidence | — | — | — | — | — | — | — | — | rung3 **REG:128 STACK:48 SHARED:27136 LOCAL:0** (at the launch_bounds ceiling, no spills) vs rung2 REG:72, rung1 REG:43; initial launch **failed** with "too many resources requested" → `__launch_bounds__(512,1)` (pre-timing fix, config unchanged) |
| 2026-09-15 | **EXP12 verdict** | — | — | — | — | — | — | — | — | Falsifier 2 fired, falsifier 1 marginal → **RE-DIAGNOSE before another rung**: shared-BW is not the dominant limiter; grid parallelism/occupancy is the measured mechanism; 3.2× unexplained overhead survives (LDS issue rate / sync stalls / 25% occupancy); three-way measured dispatch (rung3 huge-N M≥256, rung2 mid, rung1 <64) |
| 2026-09-15 | **EXP13 diagnosis — barrier/sync term (fixed 256,64 geometry, BK 16→32)** | — | — | — | — | — | — | — | — | **1.38–1.56× from halving barriers** (QKV-M64 2.5→3.9, QKV-M512 14.9→20.6, LM head 19.8→28.0 TFLOPS) — **Rung 3's BK=16 vs Rung 2's BK=32 was a self-inflicted regression** |
| 2026-09-15 | EXP13 — shared-bandwidth hypothesis | — | — | — | — | — | — | — | — | **REJECTED**: halving loads/FMA (0.25 vs 0.50) gives no consistent gain; in matched pairs the 0.50 tile sometimes wins (LM head 128,128,32 = 29.7 vs 128,128,16 = 27.7) |
| 2026-09-15 | EXP13 — grid-parallelism signature | — | — | — | — | — | — | — | — | **CONFIRMED where blocks are scarce**: QKV-M64 (32–128 blocks vs 170 SMs) tracks block count monotonically (128 blk 5.9; 64 blk 3.9/4.7/3.4; 32 blk 1.7 TFLOPS); grid-rich LM head insensitive, fewest-block variant wins |
| 2026-09-15 | **EXP13 best variants (flushed)** | — | — | — | — | — | — | — | — | LM head M=512 **31.0 TFLOPS** (256,128,BK16 — reproduces EXP12's 30.68 within 1%); QKV M=512 **24.6 TFLOPS** (64,32,BK32 with 1024 blocks — grid density beats tile size); QKV M=64 5.9 at 128 blocks |
| 2026-09-15 | **EXP13 outcome** | — | — | — | — | — | — | — | — | Diagnostic complete, all four hypotheses resolved (1 rejected, 1 supported, 1 confirmed, 1 partial); reproducibility verified (<0.1% on headline cells); **static shared is capped at 48 KB → Rung 4 must use dynamic shared for BK ≥ 32**; Rung-4 design inputs recorded |
