...
**Rung 2 measured (EXP11) — KEEP for large M** — double-tiled GEMM
(BM=128, BN=64, BK=32, 512 threads, TM=TN=4): **7.90×** over Rung 1 at LM head
M=512 (19.28 TFLOPS) and **25.09 TFLOPS = 22.5% of FFMA peak** at MLP gate+up
M=512. Prediction (a) HIT (10–30 band); (c) CONFIRMED (TFLOPS now rises with
M and plateaus). **Falsifier 2 fired at small M** (M=1 regressed 3.7–24.6×) →
pre-registered remedy adopted: **hybrid dispatch, Rung 1 for M ≤ ~64, Rung 2
above**. Measured crossover M ∈ [32, 256], centred ~64–128, bracketing the
